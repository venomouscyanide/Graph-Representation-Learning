"""
This is not authored by me.
Authored by  Jiaxuan You https://github.com/JiaxuanYou and others at SNAP Stanford(https://snap.stanford.edu/)
Taken from: https://github.com/JiaxuanYou/graph-generation/blob/master/eval/mmd.py
"""
import warnings
...
def compute_mmd(samples1, samples2, kernel=gaussian_emd, is_hist=True, *args, **kwargs):
...
def test():
    ...
    print('between samples1 and samples2: ', compute_mmd(samples1, samples2, kernel=emd,
