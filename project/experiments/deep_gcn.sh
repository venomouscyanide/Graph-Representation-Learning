...
python -m project.deep_models.deep_trainer --dataset "karate" --gpu_count 0 --cpu_count 1 --model_name "gcn" --identifier "gcn_no_norm_no_degree_information_karate"
python -m project.deep_models.deep_trainer --dataset "cora" --gpu_count 0 --cpu_count 1 --model_name "gcn" --identifier "gcn_no_norm_no_degree_information_cora"
python -m project.deep_models.deep_trainer --dataset "citeseer" --gpu_count 0 --cpu_count 1 --model_name "gcn" --identifier "gcn_no_norm_no_degree_information_citeceer"
python -m project.deep_models.deep_trainer --dataset "pubmed" --gpu_count 0 --cpu_count 1 --model_name "gcn" --identifier "gcn_no_norm_no_degree_information_pubmed"
python -m project.deep_models.deep_trainer --dataset "computers" --gpu_count 0 --cpu_count 1 --model_name "gcn" --identifier "gcn_no_norm_no_degree_information_computers"
python -m project.deep_models.deep_trainer --dataset "photo" --gpu_count 0 --cpu_count 1 --model_name "gcn" --identifier "gcn_no_norm_no_degree_information_photo"